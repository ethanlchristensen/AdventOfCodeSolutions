"""
Advent of Code 2025 - Day 11 Animation
"""
...
class AdventOfCodeDay11Effect(BaseEffect):
    def __init__(
        self,
        buffer: Buffer,
        background: str,
...
def animate(screen):
    ...
    renderer.effect = AdventOfCodeDay11Effect(
...
if __name__ in ["__main__", "day11_animate"]:
    Screen.show(animate)
