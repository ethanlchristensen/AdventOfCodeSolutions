"""
Advent of Code 2025 - Day 9 Animation
"""
...
class AdventOfCodeDay09Effect(BaseEffect):
    def __init__(
        self,
        buffer: Buffer,
        background: str,
...
def animate(screen):
    ...
    renderer.effect = AdventOfCodeDay09Effect(
...
if __name__ in ["__main__", "day09_animate"]:
    Screen.show(animate)
