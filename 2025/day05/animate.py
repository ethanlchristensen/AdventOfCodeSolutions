"""
Advent of Code 2025 - Day 5 Animation
"""

from bruhanimate import Screen, BaseEffect, Buffer, EffectRenderer, SnowEffect


class AdventOfCodeDay05Effect(BaseEffect):
    def __init__(
        self,
        buffer: Buffer,
        background: str,
...
def animate(screen):
    ...
    renderer.effect = AdventOfCodeDay05Effect(
...
if __name__ in ["__main__", "day05_animate"]:
    Screen.show(animate)
