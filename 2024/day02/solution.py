        ...
        return sum(
            [
                ...
                if (
                    False
                    if not any(
                        [report == sorted(report), report == sorted(report)[::-1]]
                    )
                    else all(
                        [
                            (
                                abs(report[idx] - report[idx + 1]) >= 1
                                and abs(report[idx] - report[idx + 1]) <= 3
                            )
                    ...
                    or any(
                        [
                            (
                                ...
                                if not any(
                                    [
                                        [v for i, v in enumerate(report) if i != idx]
                                        == sorted(
                                            [
                                                v
