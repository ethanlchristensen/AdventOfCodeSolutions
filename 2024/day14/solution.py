...
class Solution:
    ...
    def load_data(self, name='data'):
        with open(name, 'r') as file:
            ...
            for line in file.readlines():
                ...
                self.data.append((tuple(position), tuple(velocity)))
            return self.data
    ...
    def part1(self):
        ...
        for quadrant in quadrants:
            total *= self.get_quadrant_count(quadrant, tile_board)
    ...
    def part2(self): 
        ...
        # for quadrant in quadrants:
        #     total *= self.get_quadrant_count(quadrant, tile_board)
        # df = pd.DataFrame(self.data=data_frame_data, columns=["second", 0, 1, 2, 3])
